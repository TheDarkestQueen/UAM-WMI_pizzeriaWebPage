...
import {getPizzaList, getIngredientList, addPizzaToOrder} from '../redux/actions/pizza.actions'
import pizzaImg from '../assets/pizza1.jpg'
import { useEffect, useState } from "react";
import { bindActionCreators } from "redux";

function PizzaListRender() {
                    ...
                    {data.pizzaList.map(pizza => (
                        <li key={pizza.id}>
                            ...
                            <div className="pizza-view-button-order">
                                ...
                                <button onClick={ () => dispatch(addPizzaToOrder(pizza)) }>Add to order</button>
                            </div>
                        </li>
                    ))}
                </ul>
...
export default PizzaListRender;